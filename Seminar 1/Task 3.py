...
firstDesk = firstClass // -2
secondDesk = secondClass // -2
thirdDesk = thirdClass // -2
summa = firstDesk + secondDesk + thirdDesk

print(f'Наименьшее необходимое число парт - {-summa}')